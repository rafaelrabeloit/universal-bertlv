(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './bitfield-parser.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./bitfield-parser.js'));
  else {
    if (typeof globalThis['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'io.github.rafaelrabeloit.emv-tools:bertlv-emv'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'io.github.rafaelrabeloit.emv-tools:bertlv-emv'.");
    }
    if (typeof globalThis['bitfield-parser'] === 'undefined') {
      throw new Error("Error loading module 'io.github.rafaelrabeloit.emv-tools:bertlv-emv'. Its dependency 'bitfield-parser' was not found. Please, check whether 'bitfield-parser' is loaded prior to 'io.github.rafaelrabeloit.emv-tools:bertlv-emv'.");
    }
    globalThis['io.github.rafaelrabeloit.emv-tools:bertlv-emv'] = factory(typeof globalThis['io.github.rafaelrabeloit.emv-tools:bertlv-emv'] === 'undefined' ? {} : globalThis['io.github.rafaelrabeloit.emv-tools:bertlv-emv'], globalThis['kotlin-kotlin-stdlib'], globalThis['bitfield-parser']);
  }
}(function (_, kotlin_kotlin, kotlin_io_github_rafaelrabeloit_bitfield_parser) {
  'use strict';
  ...
  var RfuField = kotlin_io_github_rafaelrabeloit_bitfield_parser.$_$.b;
  ...
  var bitfield = kotlin_io_github_rafaelrabeloit_bitfield_parser.$_$.a;
  ...
  protoOf(Companion_1).zc = function (length) {
  ...
  function determineConstruction($this, tagHeader) {
    ...
    $l$block: {
      ...
      while (tmp0_iterator.n()) {
        ...
        if (constructionBit === element.ld_1) {
          tmp$ret$1 = element;
          break $l$block;
        }
      }
  ...
  protoOf(Companion_2).od = function (bytes, contextualize, $super) {
    var tmp;
  ...
  protoOf(Context).toString = function () {
    return 'Context(info=' + this.td_1 + ', description=' + this.ud_1 + ')';
  };
  protoOf(Context).hashCode = function () {
    var result = this.td_1 == null ? 0 : getStringHashCode(this.td_1);
  ...
  protoOf(ValueHandler).toString = function () {
    return 'ValueHandler(parser=' + toString(this.vd_1) + ', explainer=' + toString_0(this.wd_1) + ')';
  };
  protoOf(ValueHandler).hashCode = function () {
    var result = hashCode(this.vd_1);
  ...
  protoOf(TLVValue).d1 = function () {
    return this.yd_1.vd_1.oa(this.xd_1);
  };
  protoOf(TLVValue).zd = function (lineSeparator) {
    var explanation = new Explanation(lineSeparator);
    explanation.ce(new Line(this.yd_1.vd_1.ta(this.d1())));
    var tmp0_safe_receiver = this.yd_1.wd_1;
  ...
  function CVMResults$schema$lambda($this$bitfield) {
    $this$bitfield.s9(1, 'CVM Results', CVMResults$schema$lambda$lambda);
    return Unit_instance;
  }
  function CVMResults$schema$lambda$lambda($this$byte) {
    $this$byte.w9(0, 'CVM Performed - Cardholder verification was performed');
    $this$byte.w9(1, 'CVM Failed - Cardholder verification failed');
    $this$byte.w9(2, 'CVM Not Performed - Cardholder verification was not performed');
    $this$byte.w9(3, 'CVM Not Supported - Cardholder verification is not supported');
    $this$byte.w9(4, 'CVM Not Required - Cardholder verification is not required');
    $this$byte.w9(5, 'CVM Not Available - Cardholder verification is not available');
    $this$byte.w9(6, 'CVM Not Applicable - Cardholder verification is not applicable');
    $this$byte.ja(numberRangeToNumber(7, 7));
    return Unit_instance;
  }
  function CVMResults() {
    CVMResults_instance = this;
    var tmp = this;
    tmp.ag_1 = bitfield('CVM Results', 1, CVMResults$schema$lambda);
  ...
  function tlvToJson(tlv) {
    ...
    var valueHex = toHexString(tlv.uc_1.xd_1);
    ...
    sb.l5('"description":"' + escapeJson(context.ud_1) + '",');
    sb.l5('"length":' + tlv.a() + ',');
  ...
  function buildExplanation(tag, valueBytes) {
    var tmp;
    try {
      var length = Companion_instance_1.zc(valueBytes.length);
...
//# sourceMappingURL=emv-tools-bertlv-emv.js.map
