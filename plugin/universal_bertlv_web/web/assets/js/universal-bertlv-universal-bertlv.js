(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof globalThis['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'.");
    }
    if (typeof globalThis['Kotlin-DateTime-library-kotlinx-datetime'] === 'undefined') {
      throw new Error("Error loading module 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'. Its dependency 'Kotlin-DateTime-library-kotlinx-datetime' was not found. Please, check whether 'Kotlin-DateTime-library-kotlinx-datetime' is loaded prior to 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'.");
    }
    if (typeof globalThis['universal-bitfield'] === 'undefined') {
      throw new Error("Error loading module 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'. Its dependency 'universal-bitfield' was not found. Please, check whether 'universal-bitfield' is loaded prior to 'io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'.");
    }
    globalThis['io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'] = factory(typeof globalThis['io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'] === 'undefined' ? {} : globalThis['io.github.rafaelrabeloit.universal-bertlv:universal-bertlv'], globalThis['kotlin-kotlin-stdlib'], globalThis['Kotlin-DateTime-library-kotlinx-datetime'], globalThis['universal-bitfield']);
  }
  ...
  protoOf(Companion_0).wc = function (bytes, specifications) {
    ...
    while (offset < bytes.length) {
      ...
      result.k(tlv);
      var consumed = (tlv.ff_1.s() + tlv.gf_1.s() | 0) + tlv.hf_1.s() | 0;
      // Inline function 'kotlin.require' call
      // Inline function 'kotlin.contracts.contract' call
      if (!(consumed > 0 && consumed <= (bytes.length - offset | 0))) {
        // Inline function 'io.github.rafaelrabeloit.bertlv.Companion.fromTlvListBuffer.<anonymous>' call
        var message = 'Invalid TLV size ' + consumed + ' at offset ' + offset;
    ...
    switch (form.w1_1) {
      ...
      case 1:
        ...
        if (!(subsequentBytes > 0)) {
          // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.calculateLengthSize.<anonymous>' call
          var message = 'Indefinite lengths are not supported';
          throw IllegalArgumentException_init_$Create$(toString(message));
        }
  ...
  protoOf(Companion_1).af = function (bytes, tag, offset) {
    ...
    // Inline function 'kotlin.contracts.contract' call
    if (!(offset >= 0)) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromTlvBuffer.<anonymous>' call
      var message = 'Offset must not be negative: ' + offset;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(lengthOffset < bytes.length)) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromTlvBuffer.<anonymous>' call
      var message_0 = 'Missing length at offset ' + lengthOffset;
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(lengthSize <= (bytes.length - lengthOffset | 0))) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromTlvBuffer.<anonymous>' call
      var message_1 = 'Truncated length at offset ' + lengthOffset;
  ...
  protoOf(Companion_1).jf = function (length) {
    ...
    // Inline function 'kotlin.contracts.contract' call
    if (!(length >= 0)) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromLength.<anonymous>' call
      var message = 'Length must not be negative: ' + length;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  ...
  function calculateTagLength($this, bytes, offset, form) {
    if (form.equals(Form_SHORT_getInstance_0()))
      return 1;
    var index = offset + 1 | 0;
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(index < bytes.length)) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.calculateTagLength.<anonymous>' call
      var message = 'Truncated multi-byte tag at offset ' + offset;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    while (true) {
      if (!matches(bytes[index], 128))
      ...
      if (!(index < bytes.length)) {
        // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.calculateTagLength.<anonymous>' call
        var message_0 = 'Truncated multi-byte tag at offset ' + offset;
        throw IllegalArgumentException_init_$Create$(toString(message_0));
      }
    }
  }
  ...
  protoOf(Companion_2).le = function (bytes, offset, contextualize) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(0 <= offset ? offset <= (bytes.length - 1 | 0) : false)) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromTlvBuffer.<anonymous>' call
      var message = 'Missing tag at offset ' + offset;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  ...
  protoOf(Companion_3).cf = function (bytes, tag, length, handler, offset) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(valueStart <= bytes.length && length.md_1 <= (bytes.length - valueStart | 0))) {
      // Inline function 'io.github.rafaelrabeloit.bertlv.components.Companion.fromTlvBuffer.<anonymous>' call
      var message_0 = 'Truncated value at offset ' + valueStart + ': expected ' + length.md_1 + ' bytes';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  function power($this, base, exponent) {
    if (exponent < 0)
      return 1.0 / power($this, base, -exponent | 0);
    var tmp;
    switch (exponent) {
      case 0:
        tmp = 1.0;
  ...
  function EmvTagDescription_initEntries() {
    ...
    EmvTagDescription_APPLICATION_VERSION_NUMBER_instance = new EmvTagDescription('APPLICATION_VERSION_NUMBER', 33, 40712, 'Application Version Number', 'Version number assigned by the payment system for the application', Source_ICC_getInstance(), numberRangeToNumber(2, 2), Format_BINARY_getInstance());
    ...
    EmvTagDescription_UNPREDICTABLE_NUMBER_instance = new EmvTagDescription('UNPREDICTABLE_NUMBER', 55, 40759, 'Unpredictable Number', 'Value to provide variability and uniqueness to the generation of a cryptogram', Source_TERMINAL_getInstance(), numberRangeToNumber(4, 4), Format_BINARY_getInstance());
    ...
    EmvTagDescription_ICC_DYNAMIC_NUMBER_instance = new EmvTagDescription('ICC_DYNAMIC_NUMBER', 58, 40780, 'ICC Dynamic Number', 'Dynamic number generated by the ICC for each transaction', Source_ICC_getInstance(), numberRangeToNumber(1, 8), Format_BINARY_getInstance());
    ...
    EmvTagDescription_TERMINAL_SERIAL_NUMBER_instance = new EmvTagDescription('TERMINAL_SERIAL_NUMBER', 60, 40734, 'Terminal Serial Number', 'Uniquely identifies the terminal at a merchant location', Source_TERMINAL_getInstance(), numberRangeToNumber(8, 8), Format_ALPHANUMERIC_getInstance());
    ...
    EmvTagDescription_MERCHANT_IDENTIFIER_instance = new EmvTagDescription('MERCHANT_IDENTIFIER', 65, 40726, 'Merchant Identifier', 'Uniquely identifies the merchant', Source_TERMINAL_getInstance(), numberRangeToNumber(15, 15), Format_ALPHANUMERIC_SPECIAL_getInstance());
  ...
  function Format_ALPHANUMERIC_SPECIAL_getInstance() {
    Format_initEntries();
    return Format_ALPHANUMERIC_SPECIAL_instance;
  }
  ...
  function TransactionStatusInformation$schema$lambda$lambda($this$byte) {
    $this$byte.dc(0, 'Offline Data Authentication Was Performed');
    $this$byte.dc(1, 'Cardholder Verification Was Performed');
    $this$byte.dc(2, 'Card Risk Management Was Performed');
    $this$byte.dc(3, 'Issuer Authentication Was Performed');
    $this$byte.dc(4, 'Terminal Risk Management Was Performed');
    $this$byte.dc(5, 'Script Processing Was Performed');
    $this$byte.qc(numberRangeToNumber(6, 7));
    return Unit_instance;
  }
  function TransactionStatusInformation$schema$lambda$lambda_0($this$byte) {
    $this$byte.qc(numberRangeToNumber(0, 7));
    return Unit_instance;
  }
...
//# sourceMappingURL=universal-bertlv-universal-bertlv.js.map
