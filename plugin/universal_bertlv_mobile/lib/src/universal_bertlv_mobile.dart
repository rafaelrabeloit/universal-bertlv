...
/// Loads the native universal_bertlv shared library.
DynamicLibrary _loadLibrary() {
  if (Platform.isAndroid) {
    return DynamicLibrary.open('libuniversal_bertlv.so');
  } else if (Platform.isIOS) {
    return DynamicLibrary.process();
  } else {
    throw UnsupportedError(
      'Platform ${Platform.operatingSystem} is not supported. '
      'Use universal_bertlv_web for web targets.',
    );
  }
}
...
///
/// Uses dart:ffi to call the Kotlin/Native universal-bertlv library directly.
