...
/// Kotlin/JS module, providing a clean Dart API.

/// Represents a parsed TLV (Tag-Length-Value) element.
///
/// Created by [BertlvEmvWeb.parseTlv] or [BertlvEmvWeb.parseTlvList].
///
/// Example:
/// ```dart
...
class TlvResult {
  ...
  /// Creates a [TlvResult] from the JSON map returned by the JS module.
